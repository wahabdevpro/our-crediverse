        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-md-2">
                    <img src="../../assets/images/login/undraw_file_sync_ot38.svg" alt="Image" class="img-fluid">
                </div>
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <div class="mb-5" v-if="forgotPassword">
                            ...
                            <form @submit="login">
                                <div class="form-group first mb-5" :class="{ 'field--not-empty': username }">
                                    <label for="username">Username</label>
                                    <input type="text" v-model="username" class="form-control" id="username">

                                </div>
                                <div class="form-group last mb-4" :class="{ 'field--not-empty': password }">
                                ...
                                <div class="d-flex mb-4 align-items-center">
                                    <span class="ml-auto"><a href="#" class="forgot-pass"
                                            @click="forgotPasswordClicked">Forgot Password</a></span>
                                </div>
            ...
            try {
                ...
                if (loginResponse === true) {
                    ...
                    if (loginResponse.response.status === 401) {
                        ...
                        this.errorMessage = `Technical problem, please try again later`;
                    }
                }
            } catch (error) {
                this.isError = true;
