...
public class DailyGroupSalesReportSpecification extends hxc.ecds.protocol.rest.reports.DailyGroupSalesReportSpecification
{
	...
	public DailyGroupSalesReportSpecification()
	{
	}

	public DailyGroupSalesReportSpecification(ReportSpecification specification) throws IOException
	{
		...
		this.parameters = new DailyGroupSalesReportParameters();
		this.parameters.amend(mapper.readValue(specification.getParameters(), DailyGroupSalesReportParameters.class));
	}
	...
	public ReportSpecification toReportSpecification() throws Exception
	{
		...
		reportSpecification.setType(Report.Type.DAILY_GROUP_SALES.toString());
