...
public class DailyPerformanceByAreaSpecification extends hxc.ecds.protocol.rest.reports.DailyPerformanceByAreaSpecification {
	...
	public DailyPerformanceByAreaSpecification(ReportSpecification specification) throws IOException
	{
		...
		this.parameters = new DailyPerformanceByAreaReportParameters();
		this.parameters.amend(mapper.readValue(specification.getParameters(), DailyPerformanceByAreaReportParameters.class));
	...
	public ReportSpecification toReportSpecification() throws Exception
	{
		...
		reportSpecification.setType(Report.Type.DAILY_PERFORMANCE_BY_AREA.toString());
