...
BEGIN
	DECLARE old_version int(11) DEFAULT 96;	/* FIXME replace XX with the version this script is downgrading to, e.g. 12 */
	DECLARE new_version int(11) DEFAULT 97; /* FIXME replace YY with the version this script is downgrading from, e.g. 13  */
	...
	IF current_version != old_version THEN
		...
		START TRANSACTION;
			...
			alter table `hxc`.`ea_agent` DROP `send_daily_bundle_commission_report`;
