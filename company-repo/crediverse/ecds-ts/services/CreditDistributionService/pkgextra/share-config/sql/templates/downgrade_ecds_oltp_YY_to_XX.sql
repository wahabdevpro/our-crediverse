...
BEGIN
	DECLARE old_version int(11) DEFAULT XX;	/* FIXME replace XX with the version this script is downgrading to, e.g. 12 */
	DECLARE new_version int(11) DEFAULT YY; /* FIXME replace YY with the version this script is downgrading from, e.g. 13  */
