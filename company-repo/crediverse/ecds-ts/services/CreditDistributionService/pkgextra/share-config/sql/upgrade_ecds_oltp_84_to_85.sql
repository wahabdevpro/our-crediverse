...
BEGIN
	...
	DECLARE old_version int(11) DEFAULT 84;
	DECLARE new_version int(11) DEFAULT 85;
	...
	IF current_version != new_version THEN
		...
		START TRANSACTION;
                ...
                ALTER TABLE `hxc`.`es_webuser` ADD COLUMN `service_user` INT NULL DEFAULT NULL;
                
                CREATE TABLE `hxc`.`non_airtime_transaction_details` (
