...
BEGIN
	...
	DECLARE old_version int(11) DEFAULT 82;
	DECLARE new_version int(11) DEFAULT 83;
	...
	IF current_version != new_version THEN
      ...
      if not exists (select table_name
                    ...
                    and table_name = 'ec_transact_ex') then
            ...
            select "Created table ec_transact_ex" as "INFO";
