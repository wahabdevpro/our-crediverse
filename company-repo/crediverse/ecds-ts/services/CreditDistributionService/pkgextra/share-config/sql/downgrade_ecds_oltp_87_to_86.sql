...
BEGIN
	DECLARE old_version int(11) DEFAULT 86;
	DECLARE new_version int(11) DEFAULT 87;
	...
	IF current_version != old_version THEN
		...
		START TRANSACTION;
            ...
            ALTER TABLE eb_stage 
				MODIFY bd1 DECIMAL(19,2) NULL DEFAULT NULL,
				MODIFY bd2 DECIMAL(19,2) NULL DEFAULT NULL,
				MODIFY bd3 DECIMAL(19,2) NULL DEFAULT NULL,
				MODIFY bd4 DECIMAL(19,2) NULL DEFAULT NULL;
