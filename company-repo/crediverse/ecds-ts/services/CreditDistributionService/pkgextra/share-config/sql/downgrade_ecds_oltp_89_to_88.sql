...
BEGIN
	DECLARE old_version int(11) DEFAULT 88;
	DECLARE new_version int(11) DEFAULT 89;
	...
	IF current_version != old_version THEN
		...
		IF transaction_records < large_table_threshold THEN
			ALTER TABLE ec_transact DROP COLUMN channel_type;
		ELSE
			SELECT "=====================================================================" AS "INFO";
		...
		ALTER TABLE ea_user DROP COLUMN channel_type;
