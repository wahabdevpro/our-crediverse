...
BEGIN
	DECLARE old_version int(11) DEFAULT 76;
	DECLARE new_version int(11) DEFAULT 77;
	...
	IF current_version != new_version THEN
		...
		START TRANSACTION;
			...
			IF NOT EXISTS (select null 
                     ...
                     and COLUMN_NAME = 'allow_intratier_transfer' 
                     and TABLE_NAME = 'et_tier') then

				ALTER TABLE et_tier ADD COLUMN `allow_intratier_transfer` bit(1) NOT NULL DEFAULT 0;
			END IF;
