...
BEGIN
	DECLARE old_version int(11) DEFAULT 1;
	DECLARE new_version int(11) DEFAULT 2;
	...
	IF current_version_string != new_version THEN
		...
		START TRANSACTION;
			...
			ADD COLUMN `a_area_name` varchar(128) DEFAULT NULL,
			ADD COLUMN `b_area_name` varchar(128) DEFAULT NULL;
