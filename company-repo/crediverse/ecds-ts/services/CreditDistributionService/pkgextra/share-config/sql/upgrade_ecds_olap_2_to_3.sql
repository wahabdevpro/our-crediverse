...
BEGIN
	DECLARE old_version int(11) DEFAULT 2;
	DECLARE new_version int(11) DEFAULT 3;
	...
	IF current_version_string != new_version THEN
		...
		START TRANSACTION;
			...
			ADD COLUMN `a_owner_msisdn` varchar(30) DEFAULT NULL,
			ADD COLUMN `b_owner_msisdn` varchar(30) DEFAULT NULL;
