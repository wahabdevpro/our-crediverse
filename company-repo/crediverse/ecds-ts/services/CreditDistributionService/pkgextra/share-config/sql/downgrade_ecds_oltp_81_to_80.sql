...
BEGIN
	...
	IF current_version != old_version THEN
		...
		START TRANSACTION;
			...
			/* MEAT: START */
			SELECT count(*) INTO revert_records FROM ec_transact a, ec_transact rel where a.type in ('PA', 'FR') and a.reversed_id = rel.id and rel.type in ('SL','SB','ST') and a.amount < 0;
			IF revert_records > 0 THEN
