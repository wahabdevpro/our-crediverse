...
BEGIN
	DECLARE old_version int(11) DEFAULT 77;	/* FIXME replace XX with the version this script is downgrading to, e.g. 12 */
	DECLARE new_version int(11) DEFAULT 78; /* FIXME replace YY with the version this script is downgrading from, e.g. 13  */
	...
	IF current_version != old_version THEN
		...
		START TRANSACTION;
			...
			/* NOT DOING ANYTHING */ 
			SELECT CONCAT("Downgrade script not doing anything tangible to reverse upgrade to ", old_version) AS "INFO";
