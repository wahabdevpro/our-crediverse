...
public interface IZTEConnection extends IConnection
{
	// //////////////////////////////////////////////////////////////////////////////////////
	//
	// Housekeeping
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 123, 124, 126, 127, 260, 999
	 */
//	public GetAccumulatorsResponse getAccumulators(GetAccumulatorsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 133, 260, 999
	 */
//	public GetAllowedServiceClassesResponse getAllowedServiceClasses(GetAllowedServiceClassesRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100
	 */
//	public hxc.utils.protocol.ucip.GetCapabilitesResponse getCapabilites(hxc.utils.protocol.ucip.GetCapabilitesRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 242, 999
	 */
//	public GetDiscountInformationResponse getDiscountInformation(GetDiscountInformationRequest request) throws ZTEException;
...
//TODO
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 103, 107, 108, 109, 110, 111, 112, 113, 115, 119, 126, 260, 999
	 */
	//public GetRefillOptionsResponse getRefillOptions(GetRefillOptionsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 260
	 */
	//public GetUsageThresholdsAndCountersResponse getUsageThresholdsAndCounters(GetUsageThresholdsAndCountersRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 1, 2, 100, 102, 103, 104, 105, 107, 108, 109, 110, 111, 112, 113, 114, 115, 117, 119, 120, 121, 122, 123, 126, 136, 153, 160, 161, 165, 167, 176, 177,
	 *             178, 179, 214, 225, 248, 260, 999
	 */
	//public RefillResponse refill(RefillRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 126, 128, 138, 141, 157, 204, 241, 260, 999
	 */
	//public UpdateAccountDetailsResponse updateAccountDetails(UpdateAccountDetailsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 147, 148, 260, 999
	 */
	//public UpdateCommunityListResponse updateCommunityList(UpdateCommunityListRequest request) throws ZTEException;
...
//TODO 
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 124, 260, 999
	 */
	//public UpdateSubscriberSegmentationResponse updateSubscriberSegmentation(UpdateSubscriberSegmentationRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 216, 217, 219, 220, 221, 243, 244, 245, 247, 260
	 */
	//public UpdateUsageThresholdsAndCountersResponse updateUsageThresholdsAndCounters(UpdateUsageThresholdsAndCountersRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 190, 191, 193, 195, 196, 197, 198, 199, 200, 201, 233, 235, 236, 255, 257, 260, 999
	 */
	//public AddPeriodicAccountManagementDataResponse addPeriodicAccountManagementData(AddPeriodicAccountManagementDataRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 127, 207, 208, 260, 999
	 */
	//public DeleteAccumulatorsResponse deleteAccumulators(DeleteAccumulatorsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 139, 209, 210, 211, 222, 247, 249, 260, 999
	 */
	//public DeleteDedicatedAccountsResponse deleteDedicatedAccounts(DeleteDedicatedAccountsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 165, 247, 260
	 */
	//public DeleteOfferResponse deleteOffer(DeleteOfferRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 191, 197, 198, 201, 232, 255, 260, 999
	 */
	//public DeletePeriodicAccountManagementDataResponse deletePeriodicAccountManagementData(DeletePeriodicAccountManagementDataRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 156, 260, 999
	 */
	//public DeleteSubscriberResponse deleteSubscriber(DeleteSubscriberRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 239, 260
	 */
	//public DeleteTimeRestrictionResponse deleteTimeRestriction(DeleteTimeRestrictionRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 216, 218, 246, 260
	 */
	//public DeleteUsageThresholdsResponse deleteUsageThresholds(DeleteUsageThresholdsRequest request) throws ZTEException;
	 ...
	 *             if ZTE returns any one of: 0, 100
	 */
	//public hxc.utils.protocol.acip.GetCapabilitesResponse getCapabilites(hxc.utils.protocol.acip.GetCapabilitesRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 260, 999
	 */
	//public GetPromotionCountersResponse getPromotionCounters(GetPromotionCountersRequest request) throws ZTEException;
	 ...
	 *             if ZTE returns any one of: 0, 100, 102, 260, 999
	 */
	//public GetPromotionPlansResponse getPromotionPlans(GetPromotionPlansRequest request) throws ZTEException;
	 ...
	 *             if ZTE returns any one of: 0, 100, 102, 239, 260
	 */
	//public GetTimeRestrictionResponse getTimeRestriction(GetTimeRestrictionRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 141, 142, 155, 157, 190, 191, 193, 195, 196, 198, 199, 200, 201, 203, 233, 235, 236, 240, 257, 260, 999
	 */
	//public InstallSubscriberResponse installSubscriber(InstallSubscriberRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 143, 144, 145, 146, 260, 999
	 */
	//public LinkSubordinateSubscriberResponse linkSubordinateSubscriber(LinkSubordinateSubscriberRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 126, 191, 197, 199, 201, 202, 255, 260, 999
	 */
	//public RunPeriodicAccountManagementResponse runPeriodicAccountManagement(RunPeriodicAccountManagementRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 127, 134, 135, 260, 999
	 */
	//public UpdateAccountManagementCountersResponse updateAccountManagementCounters(UpdateAccountManagementCountersRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 127, 134, 135, 260, 999
	 */
	//public UpdateAccumulatorsResponse updateAccumulators(UpdateAccumulatorsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 126, 142, 250, 251, 252, 253, 254, 260, 999
	 */
	//public UpdateCommunicationIDResponse updateCommunicationID(UpdateCommunicationIDRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 233, 234, 235, 236, 255, 257, 260, 999
	 */
	//public UpdatePeriodicAccountManagementDataResponse updatePeriodicAccountManagementData(UpdatePeriodicAccountManagementDataRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 126, 260, 999
	 */
	//public UpdatePromotionCountersResponse updatePromotionCounters(UpdatePromotionCountersRequest request) throws ZTEException;

	/**
	 * updatePromotionPlan
	 * 
	 * The message UpdatePromotionPlan can Add, Set or Delete a promotion plan allocation to an account. The promotion plan ID has to be defined already in the business configuration in ZTE, where the
	 ...
	 * trees and the IDs allowed in the "Update Promotion Plan" needs to be added to the Promotion Plan window. For more information see, ZTE User's Guide Service Configuration Administration,
	 * Reference [3].
	 * 
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 149, 150, 151, 204, 260, 999
	 */
	//public UpdatePromotionPlanResponse updatePromotionPlan(UpdatePromotionPlanRequest request) throws ZTEException;
	 ...
	 *             if ZTE returns any one of: 0, 100, 102, 104, 126, 260, 999
	 */
	//public UpdateRefillBarringResponse updateRefillBarring(UpdateRefillBarringRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 104, 105, 106, 123, 124, 126, 136, 139, 153, 163, 164, 167, 213, 226, 227, 230, 257, 260, 999
	 */
	//public UpdateSubDedicatedAccountsResponse updateSubDedicatedAccounts(UpdateSubDedicatedAccountsRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 152, 260, 999
	 */
	//public UpdateTemporaryBlockedResponse updateTemporaryBlocked(UpdateTemporaryBlockedRequest request) throws ZTEException;
	 ...
	 * @throws ZTEException
	 *             if ZTE returns any one of: 0, 100, 102, 240, 260
	 */
	//public UpdateTimeRestrictionResponse updateTimeRestriction(UpdateTimeRestrictionRequest request) throws ZTEException;
