...
public class AirException extends Exception
{
	...
	public final static int AUTORIZATION_FAILURE = -401;
	public final static int INCOMPLETE_REQUEST = -400;
	public final static int FORBIDDEN = -403;
	public final static int SERVER_OVERLOAD = -1007;
	public final static int OTHER_TRANSPORT_ERROR = 9999;
	public static final Integer NON_DETERMINISTIC_ERROR = 999;
	 ...
	 *            Air Response Code
	 */
	public AirException(int responseCode, String host)
	{
	...
	public AirException(int responseCode)
	{
		super(getResponseMessage(responseCode));
		this.responseCode = responseCode;
	}
	 ...
	 */
	public AirException(int responseCode, Throwable cause, String host)
	{
	 ...
	 *            Inner Exception
	 */
	public AirException(String message, Throwable cause, String host)
	{
		super(message, cause);
		this.host = host;
		if (cause.getCause() instanceof java.net.SocketTimeoutException)
		{
			if ((cause instanceof hxc.utils.xmlrpc.XmlRpcException) && (((hxc.utils.xmlrpc.XmlRpcException)cause).getContext() == hxc.utils.xmlrpc.XmlRpcException.Context.Connect))
				this.responseCode = AirException.CONNECT_TIMEOUT;
			else
				this.responseCode = AirException.TIMEOUT;
		}	
		else
			this.responseCode = AirException.OTHER_TRANSPORT_ERROR;
	}
	...
	public String getMessage()
	{
		...
		return String.format("%s Air-Node: [%s]", super.getMessage(), host);
	}
	...
	public boolean isDeterministic()
	{
		switch (responseCode)
		{
			case AirException.TIMEOUT: return false;
