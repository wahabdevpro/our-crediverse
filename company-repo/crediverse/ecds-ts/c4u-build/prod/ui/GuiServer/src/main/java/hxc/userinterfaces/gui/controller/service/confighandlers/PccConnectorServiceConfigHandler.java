...
public class PccConnectorServiceConfigHandler extends BaseServiceConfigHandler
{

	@Override
	public long getServiceID()
	{
		return -9223372036554775808L;	//PCC_CONNECTOR_ID
	}
			...
			throws Exception
	{
		...
		return "genericserviceconfig/genericServiceConfig";
	}
