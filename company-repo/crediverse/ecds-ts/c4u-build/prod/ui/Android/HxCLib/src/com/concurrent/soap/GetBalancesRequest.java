...
public class GetBalancesRequest extends RequestHeader implements ICallable<GetBalancesResponse>
{
	...
	protected boolean requestSMS = false;
	
	private static final long serialVersionUID = -6071496180879268268L;
	...
	public void serialise(ISerialiser serialiser)
	{
		...
		serialiser.add("requestSMS", requestSMS);
	}
	
	@Override
	public GetBalancesResponse deserialiseResponse(ISerialiser serialiser)
	{
		GetBalancesResponse response = new GetBalancesResponse(this);
