...
public class AddCreditTransferRequest extends RequestHeader implements ICallable<AddCreditTransferResponse>
{
	// //////////////////////////////////////////////////////////////////////////////////////
	//
	// Fields
	...
	public void serialise(ISerialiser serialiser)
	{
		...
		serialiser.add("nextTransferDate", nextTransferDate);
		serialiser.add("transferLimit", transferLimit);
		serialiser.add("transferThreshold", transferThreshold);
		serialiser.add("pin", pin);

	}

	@Override
	public AddCreditTransferResponse deserialiseResponse(ISerialiser serialiser)
	{
		AddCreditTransferResponse response = new AddCreditTransferResponse(this);
