...
public class RemoveMemberRequest extends RequestHeader implements ICallable<RemoveMemberResponse>
{
	// //////////////////////////////////////////////////////////////////////////////////////
	//
	// Fields
	...
	@Override
	public RemoveMemberResponse deserialiseResponse(ISerialiser serialiser)
	{
		RemoveMemberResponse response = new RemoveMemberResponse(this);
