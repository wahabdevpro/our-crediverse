...
public interface IFriendsAndFamilyService
{
	public static final String DEFAULT_VARIANT_ID = "LCL_ONNET";
	public static final int DEFAULT_SERVICE_CLASS_ID = 0;

	public abstract boolean processFAF(ResponseHeader response, CdrBase cdr, IDatabaseConnection db, String variantID, String subscriberNumber, String recipientNumber);
