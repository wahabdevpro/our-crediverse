...
/**
 * GetAllowedServiceClassesResponseMember
 * 
 */
public class GetAllowedServiceClassesResponseMember
{
	/*-
	...
	/*
	 * The serviceClassList parameter contains the list of new service classes which the subscriber is allowed to change to.
	 */
	@Air(Range = "0:9999")
	public Integer serviceClassList;
