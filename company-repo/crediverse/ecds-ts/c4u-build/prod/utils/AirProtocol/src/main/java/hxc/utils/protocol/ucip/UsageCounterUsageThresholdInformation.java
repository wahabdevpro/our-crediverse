...
public class UsageCounterUsageThresholdInformation
{
	...
	public UsageCounterUsageThresholdInformation(UsageCounterUsageThresholdInformation usageCounterUsageThresholdInformation)
	{
		this.usageCounterID = usageCounterUsageThresholdInformation.usageCounterID;
		this.usageCounterValue = usageCounterUsageThresholdInformation.usageCounterValue;
		this.usageCounterMonetaryValue1 = usageCounterUsageThresholdInformation.usageCounterMonetaryValue1;
		this.usageCounterMonetaryValue2 = usageCounterUsageThresholdInformation.usageCounterMonetaryValue2;

		if (usageCounterUsageThresholdInformation.usageThresholdInformation != null)
		{
			this.usageThresholdInformation = new UsageThresholdInformation[usageCounterUsageThresholdInformation.usageThresholdInformation.length];
			for (int index = 0; index < usageCounterUsageThresholdInformation.usageThresholdInformation.length; index++)
			{
				this.usageThresholdInformation[index] = new UsageThresholdInformation(usageCounterUsageThresholdInformation.usageThresholdInformation[index]);
			}
		}

		this.associatedPartyID = usageCounterUsageThresholdInformation.associatedPartyID;
		this.productID = usageCounterUsageThresholdInformation.productID;
	}
