...
/**
 * UpdateRefillBarringRequestMember
 * 
 */
public class UpdateRefillBarringRequestMember
{
	/*-
	...
	/*-
	 * The refillBarAction parameter describe what action to apply to the refill
	 * bar counter.
	 *
	 * Possible Values:
	 * ----------------
	 * CLEAR:	Clear the counter
	 * STEP:	Increase counter by one
	 * BAR:	Immediate barring of refill
	 */
	@Air(Mandatory = true)
	public String refillBarAction;
