...
/**
 * UpdateAccountManagementCountersRequestMember
 * 
 */
public class UpdateAccountManagementCountersRequestMember
{
	/*-
	...
	@Air(Mandatory = true)
	public CounterUpdateInformation[] counterUpdateInformation;
