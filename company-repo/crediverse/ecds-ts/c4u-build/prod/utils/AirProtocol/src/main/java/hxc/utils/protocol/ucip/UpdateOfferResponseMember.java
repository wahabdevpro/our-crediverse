...
/**
 * UpdateOfferResponseMember
 * 
 */
public class UpdateOfferResponseMember implements IResponseHeader2
{
	/*-
	...
	public DedicatedAccountChangeInformation[] getDedicatedAccountChangeInformation()
	{
		return dedicatedAccountChangeInformation;
	}

	public void setDedicatedAccountChangeInformation(DedicatedAccountChangeInformation[] dedicatedAccountChangeInformation)
	{
