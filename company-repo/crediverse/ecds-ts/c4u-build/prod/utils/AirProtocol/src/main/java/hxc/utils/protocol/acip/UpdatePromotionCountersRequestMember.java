...
/**
 * UpdatePromotionCountersRequestMember
 * 
 */
public class UpdatePromotionCountersRequestMember
{
	/*-
	...
	/*
	 * The promotionRefillAmountRelative parameter specifies an amount to be adjusted to the accumulated value of account refills made within the current promotion plan of a subscriber.
	 */
	@Air(Range = "-999999999999:999999999999", Format = "Price")
	@XmlRpcAsString
	public Long promotionRefillAmountRelative;

	/*
	 * The promotionRefillCounterStepRelative parameter contains the number of steps to be adjusted to the accumulated number of account refills within the current promotion plan of a subscriber.
	 */
	@Air(Range = "-255:255")
	public Integer promotionRefillCounterStepRelative;

	/*
	 * The progressionRefillAmountRelative parameter specifies an amount to be adjusted to the accumulated value of account refill for promotion plan
	 */
	@Air(Range = "-999999999999:999999999999", Format = "Price")
	@XmlRpcAsString
	public Long progressionRefillAmountRelative;

	/*
	 * The progressionRefillCounterStepRelative parameter contains the number of steps to be adjusted on the accumulated number of account refills for promotion plan progression.
	 */
	@Air(Range = "-255:255")
	public Integer progressionRefillCounterStepRelative;
