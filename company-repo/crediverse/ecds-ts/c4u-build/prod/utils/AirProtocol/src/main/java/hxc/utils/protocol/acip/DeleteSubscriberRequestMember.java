...
/**
 * DeleteSubscriberRequestMember
 * 
 */
public class DeleteSubscriberRequestMember
{
	/*-
	...
	/*-
	 * The deleteReasonCode parameter allows the user to set a reason to why an
	 * account and/or subscriber is deleted.
	 *
	 * Possible Values:
	 * ----------------
	 * 0:	Reserved for Service expired, as defined by the life cycle of the account
	 * 1-255:	Free for user to define
	 */
	public Integer deleteReasonCode;

	/*
	 * Thebarring parameter contains an indication whether barring in HLR is to be performed prior to deletion
	 */
	public Boolean barring;
