...
/**
 * DeleteUsageThresholdsRequestMember
 * 
 */
public class DeleteUsageThresholdsRequestMember implements IRequestHeader2
{
	/*-
	...
	@Air(Mandatory = true)
	public UsageThresholds[] usageThresholds;
	...
	public UsageThresholds[] getUsageThresholds()
	{
		return usageThresholds;
	}

	public void setUsageThresholds(UsageThresholds[] usageThresholds)
	{
