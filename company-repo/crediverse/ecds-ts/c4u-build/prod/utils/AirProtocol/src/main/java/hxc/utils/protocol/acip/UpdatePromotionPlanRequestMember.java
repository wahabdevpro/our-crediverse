...
/**
 * UpdatePromotionPlanRequestMember
 * 
 */
public class UpdatePromotionPlanRequestMember
{
	/*-
	...
	/*-
	 * The promotionPlanActionparameter is used to indicate which action to
	 * take when updating the promotion plan data on account.
	 *
	 * Possible Values:
	 * ----------------
	 * ADD:	Assign new promotion plan
	 * SET:	Update plan ID and/or start and end dates
	 * DELETE:	Delete promotion plan
	 */
	@Air(Mandatory = true)
	public String promotionPlanAction;
	...
	/*
	 * The promotionPlanIDCurrent parameter contains the identity of one of the current promotion plans of a subscriber.
	 */
	@Air(Length = "1:4", Format = "Alphanumeric")
	public String promotionPlanIDCurrent;

	/*
	 * The promotionOldStartDate parameter specifies the old start date of the associated promotion plan.
	 */
	public Date promotionOldStartDate;

	/*
	 * The promotionOldEndDate parameter specifies the old end date of the associated promotion plan.
	 */
	public Date promotionOldEndDate;
