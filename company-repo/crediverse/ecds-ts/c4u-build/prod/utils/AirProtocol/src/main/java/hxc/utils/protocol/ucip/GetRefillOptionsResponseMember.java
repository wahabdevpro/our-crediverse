...
/**
 * GetRefillOptionsResponseMember
 * 
 */
public class GetRefillOptionsResponseMember
{
	/*-
	...
	/*
	 * This refillOptions parameter contains the value of a refill option. Note: The refillOptions can be repeated several times for GetRefillOptions Response.
	 */
	@Air(Range = "1:999")
	public Integer refillOptions;
