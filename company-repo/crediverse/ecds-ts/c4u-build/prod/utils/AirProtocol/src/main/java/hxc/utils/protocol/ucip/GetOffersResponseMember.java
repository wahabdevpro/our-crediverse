...
/**
 * GetOffersResponseMember
 * 
 * If FaF information is requested, it will be supplied in the offerInformatio n struct. If dedicated account information is requested it will be supplied in the dedicatedAccountInformation struct at
 * low detail level.
 */
public class GetOffersResponseMember implements IResponseHeader
{
	/*-
