 ...
 */
@XmlRpcMethod(name = "UpdateBalanceAndDate")
public class UpdateBalanceAndDateRequest
{
	public UpdateBalanceAndDateRequestMember member;

	public UpdateBalanceAndDateRequest()
	{
		member = new UpdateBalanceAndDateRequestMember();
	}
}
