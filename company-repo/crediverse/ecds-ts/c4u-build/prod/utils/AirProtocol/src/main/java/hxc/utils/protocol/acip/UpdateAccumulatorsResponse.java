 ...
 */
public class UpdateAccumulatorsResponse
{
	public UpdateAccumulatorsResponseMember member;

	public UpdateAccumulatorsResponse()
	{
		member = new UpdateAccumulatorsResponseMember();
	}
}
