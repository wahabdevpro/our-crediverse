...
/**
 * DedicatedAccountChangeInformation
 * 
 * The struct dedicatedAccountChangeInformation contains information of changes done to balances and dates for dedicated accounts. A dedicatedAccountChangeInformation struct with no value or date
 * parameters constitutes a composite dedicated account with no assigned sub dedicated account. It is enclosed in a <struct> of its own. Structs are placed in an <array>.
 */
public class DedicatedAccountChangeInformation
{
	...
	public SubDedicatedAccountChangeInformation[] subDedicatedAccountChangeInformation;
	...
	//
	// /////////////////////////////////
	public DedicatedAccountChangeInformation()
	{
