...
/**
 * UpdateUsageThresholdsAndCountersRequestMember
 * 
 */
public class UpdateUsageThresholdsAndCountersRequestMember implements IRequestHeader2
{
	/*-
	...
	/*
	 * The updateUsageCounterForMultiUser parameter indicates that the request should be performed for all subscribers in a multi user account or for the provider and all consumers. It is only
	 * possible to perform a reset on multiple subscribers.
	 */
	@Air(Range = "1", Format = "Numeric")
	public Integer updateUsageCounterForMultiUser;

	public UsageCounterUpdateInformation[] usageCounterUpdateInformation;

	public UsageThresholdUpdateInformation[] usageThresholdUpdateInformation;
	...
	public Integer getUpdateUsageCounterForMultiUser()
	{
		return updateUsageCounterForMultiUser;
	}

	public void setUpdateUsageCounterForMultiUser(Integer updateUsageCounterForMultiUser)
	{
		this.updateUsageCounterForMultiUser = updateUsageCounterForMultiUser;
	}

	public UsageCounterUpdateInformation[] getUsageCounterUpdateInformation()
	{
		return usageCounterUpdateInformation;
	}

	public void setUsageCounterUpdateInformation(UsageCounterUpdateInformation[] usageCounterUpdateInformation)
	{
		this.usageCounterUpdateInformation = usageCounterUpdateInformation;
	}

	public UsageThresholdUpdateInformation[] getUsageThresholdUpdateInformation()
	{
		return usageThresholdUpdateInformation;
	}

	public void setUsageThresholdUpdateInformation(UsageThresholdUpdateInformation[] usageThresholdUpdateInformation)
	{
		this.usageThresholdUpdateInformation = usageThresholdUpdateInformation;
	}
