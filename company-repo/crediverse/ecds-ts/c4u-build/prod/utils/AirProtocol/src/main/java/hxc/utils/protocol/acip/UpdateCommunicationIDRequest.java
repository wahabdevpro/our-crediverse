 ...
 * parameter.
 */
@XmlRpcMethod(name = "UpdateCommunicationID")
public class UpdateCommunicationIDRequest
{
	public UpdateCommunicationIDRequestMember member;

	public UpdateCommunicationIDRequest()
	{
		member = new UpdateCommunicationIDRequestMember();
	}
}
