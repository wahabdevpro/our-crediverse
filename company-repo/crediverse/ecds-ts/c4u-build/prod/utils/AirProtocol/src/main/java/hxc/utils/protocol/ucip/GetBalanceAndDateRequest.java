 ...
 */
@XmlRpcMethod(name = "GetBalanceAndDate")
public class GetBalanceAndDateRequest
{
	public GetBalanceAndDateRequestMember member;

	public GetBalanceAndDateRequest()
	{
		member = new GetBalanceAndDateRequestMember();
	}
}
