...
/**
 * DeleteAccumulatorsRequestMember
 * 
 */
public class DeleteAccumulatorsRequestMember implements IRequestHeader2
{
	/*-
	...
	@Air(Mandatory = true)
	public AccumulatorIdentifier[] accumulatorIdentifier;
	...
	public AccumulatorIdentifier[] getAccumulatorIdentifier()
	{
		return accumulatorIdentifier;
	}

	public void setAccumulatorIdentifier(AccumulatorIdentifier[] accumulatorIdentifier)
	{
		this.accumulatorIdentifier = accumulatorIdentifier;
	}
