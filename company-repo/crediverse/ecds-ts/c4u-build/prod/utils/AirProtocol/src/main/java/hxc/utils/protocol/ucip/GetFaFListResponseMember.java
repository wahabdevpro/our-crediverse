...
/**
 * GetFaFListResponseMember
 * 
 */
public class GetFaFListResponseMember implements IResponseHeader
{
	...
	/*
	 * The fafChargingNotAllowedFlag parameter is used to indicate that charged Family and Friends (FaF) administration is not allowed for the current service class
	 */
	public Boolean fafChargingNotAllowedFlag;
	...
	public Boolean getFafChargingNotAllowedFlag()
	{
		return fafChargingNotAllowedFlag;
	}

	public void setFafChargingNotAllowedFlag(Boolean fafChargingNotAllowedFlag)
	{
