...
public class UnsubscribeCall extends MethodCall
{
	final static Logger logger = LoggerFactory.getLogger(UnsubscribeCall.class);
	// //////////////////////////////////////////////////////////////////////////////////////
	//
	// Fields
	//
	...
	private static final String NAMES_HAS_CHARGE = "USUB_HAS_CHARGE";
	...
	private IValueT<Boolean> hasCharge = new IValueT<Boolean>()
	{
		...
		{
			return state.get(UnsubscribeCall.this, NAMES_HAS_CHARGE);
		}
	};
	...
	//
	// /////////////////////////////////
	public UnsubscribeCall(Action afterAction, Action errorAction, IValueT<Number> subscriber, IValueT<String> serviceID, IValueT<String> variantID, IValueT<Boolean> rateOnly)
	{
	...
	public Action execute(IProcessState state, String command)
	{
		try
		{
			UnsubscribeRequest request = state.getRequest(UnsubscribeRequest.class);
			...
			UnsubscribeResponse response = state.getVasService().unsubscribe(state, request);
