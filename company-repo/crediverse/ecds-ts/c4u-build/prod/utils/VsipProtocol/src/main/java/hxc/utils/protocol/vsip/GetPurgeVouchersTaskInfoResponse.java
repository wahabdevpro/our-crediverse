...
public class GetPurgeVouchersTaskInfoResponse implements IVsipResponse
{
	// //////////////////////////////////////////////////////////////////////////////////////
	//
	// Fields
	...
	private GetPurgeVouchersTaskInfoTasks[] tasks;
	...
	public GetPurgeVouchersTaskInfoTasks[] getTasks()
	{
		return tasks;
	}

	public void setTasks(GetPurgeVouchersTaskInfoTasks[] tasks)
	{
		this.tasks = tasks;
	}
	...
	private boolean validateTasks(IValidationContext context, boolean required, GetPurgeVouchersTaskInfoTasks[] tasks)
	{
		if (tasks == null || tasks.length == 0)
			return !required;

		for (GetPurgeVouchersTaskInfoTasks task : tasks)
		{
