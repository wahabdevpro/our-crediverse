...
/*
CREATE: PUT ~/reports/wholesaler_performance?sort=...&filter=...&timeInterval.start=...&timeInterval.end=...&relativeTimeRange.code=...&name=...
UPDATE: PUT ~/reports/wholesaler_performance/{id}?sort=...&filter=...&timeInterval.start=...&timeInterval.end=...&relativeTimeRange.code=...&name=...
LIST: GET ~/reports/wholesaler_performance
LOAD: GET ~/reports/wholesaler_performance/{id}
DOWNLOAD REPORT DATA: JSON: GET ~/reports/wholesaler_performance/{id}/json?first=...&max=...&timeInterval.start=...&timeInterval.end=...&relativeTimeRange.code=...&relativeTimeRange.reference=...
DOWNLOAD REPORT DATA: CSV: GET ~/reports/wholesaler_performance/{id}/csv?first=...&max=...&timeInterval.start=...&timeInterval.end=...&relativeTimeRange.code=...&relativeTimeRange.reference=...
...
public class WholesalerPerformanceReport
{
	public static enum TransactionType //implements Transaction.IType
	{
		...
		ADJUST(new Transaction.Type[] {Transaction.Type.ADJUST}),
		REVERSE(new Transaction.Type[] {Transaction.Type.REVERSE, Transaction.Type.REVERSE_PARTIALLY}),
		PROMOTION_REWARD(new Transaction.Type[] {Transaction.Type.PROMOTION_REWARD}),
	...
	public static enum ResultField implements Report.IResultField
	{
		...
		B_AGENT_ID("b_AgentID",Integer.class),
		B_ACCOUNT_NUMBER("b_AccountNumber",String.class),
		B_MOBILE_NUMBER("b_MobileNumber",String.class),
		B_IMEI("b_IMEI",String.class),
		B_IMSI("b_IMSI",String.class),
		B_NAME("b_Name",String.class),

		B_TIER_NAME("b_TierName",String.class),
		B_GROUP_NAME("b_GroupName",String.class),
		B_SERVICE_CLASS_NAME("b_ServiceClassName",String.class),

		B_OWNER_ID("b_OwnerID",String.class),
		B_OWNER_MOBILE_NUMBER("b_OwnerMobileNumber",String.class),
		B_OWNER_IMSI("b_OwnerImsi",String.class),
		B_OWNER_NAME("b_OwnerName",String.class),
	...
	public static enum FilterField implements Report.IFilterField
	{
		...
		B_AGENT_ID("b_AgentID", String.class, Report.FilterOperator.getStringOperators()),
		B_MOBILE_NUMBER("b_MobileNumber", String.class, Report.FilterOperator.getStringOperators()),

		B_TIER_NAME("b_TierName", String.class, Report.FilterOperator.getStringOperators()),
		B_GROUP_NAME("b_GroupName", String.class, Report.FilterOperator.getStringOperators()),
		B_SERVICE_CLASS_NAME("b_ServiceClassName", String.class, Report.FilterOperator.getStringOperators()),

		B_OWNER_ID("b_OwnerID", String.class, Report.FilterOperator.getStringOperators()),
		B_OWNER_MOBILE_NUMBER("b_OwnerMobileNumber", String.class, Report.FilterOperator.getStringOperators()),
		
		B_IMEI("b_IMEI", String.class, Report.FilterOperator.getStringOperators()),

		TOTAL_AMOUNT("totalAmount", BigDecimal.class, Report.FilterOperator.getNumericOperators()),
		
		DISPOSITION("disposition", String.class, Report.FilterOperator.getEnumOperators());
	...
	protected WholesalerPerformanceReport()
	{
	}
}
