define( ['jquery', 'underscore', 'App', 'backbone', 'marionette', "handlebars", 
    ...
    function($, _, App, BackBone, Marionette, Handlebars, HBHelper, ReportModel, ReportScheduleModel, AccountBalanceSummaryReportListTableView, ReportScheduleDialogView, CommonUtils, UserCollection) {
        ...
        var AccountBalanceSummaryReportListView =  AccountBalanceSummaryReportListTableView.extend( {
        	...
        	attributes: {
  		  	...
  		  	url: 'api/reports/accountbalancesummary/list',
			urlSchedule: 'api/reports/account_balance_summary',
            ...
            deleteReport: function(ev) {
            	...
            	CommonUtils.delete({
	        		...
	        		url: 'api/reports/accountbalancesummary/'+data.id,
	        		data: data,
	        		context: {
