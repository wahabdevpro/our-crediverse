define( ['jquery', 'underscore', 'App', 'backbone', 'marionette', 'utils/CommonUtils', 'views/reports/ReportListTableView'],
    function($, _, App, BackBone, Marionette, CommonUtils, ReportListTableView) {
        ...
        var AccountBalanceSummaryReportListTableView = ReportListTableView.extend( {
        	tagName: 'div',
        	currentFilter: {}, // Used to keep track of filter settings for use by export.
        	i18ntxt: App.i18ntxt.reports.accountBalanceSummaryList,
            ...
            renderTable: function(options) {
            	...
            	var table = this.$('.accountbalancesummarylisttable');
                      ...
                      "columns": [
                    	   {
							   ...
							   render: function(data, type, row, meta) {
								   return '<a href="#accountBalanceSummaryReport/'+row.id+'" class="routerlink">'+data+'</a>';
							   }
                    	   },
                    	   {
                    		   data: "description",
                    	   ...
                    	   },
                    	   {
							   ...
							   render: function(data, type, row, meta) {
                   	            	...
                   	            	if (App.hasPermission("Reports", "Update")) {
                   	            		...
                   	            		buttons.push("<a href='#accountBalanceSummaryReport/"+row.id+"/edit' class='btn btn-primary routerlink btn-xs'>"+App.i18ntxt.global.editBtn+"</a>");
                   	            	}
        ...
        return AccountBalanceSummaryReportListTableView;
    });
