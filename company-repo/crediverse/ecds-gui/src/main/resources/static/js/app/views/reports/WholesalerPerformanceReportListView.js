define( ['jquery', 'underscore', 'App', 'backbone', 'marionette', "handlebars", 
         'utils/HandlebarHelpers', 'models/ReportModel', 'views/reports/WholesalerPerformanceReportListTableView', 'utils/CommonUtils', 'collections/UserCollection', 'datatables'],
    function($, _, App, BackBone, Marionette, Handlebars, HBHelper, ReportModel, WholesalerPerformanceReportListTableView, CommonUtils, UserCollection) {
        ...
        var WholesalerPerformanceReportListView =  WholesalerPerformanceReportListTableView.extend( {
        	...
        	attributes: {
  		  	...
  		  	url: 'api/reports/wholesalerperformance/list',
			urlSchedule: 'api/reports/wholesaler_performance',
            ...
            deleteReport: function(ev) {
            	...
            	CommonUtils.delete({
	        		...
	        		url: 'api/reports/wholesalerperformance/'+data.id,
	        		data: data,
	        		context: {
