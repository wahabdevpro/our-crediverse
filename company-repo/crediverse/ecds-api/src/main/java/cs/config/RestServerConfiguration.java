...
public class RestServerConfiguration
{
	...
	private String thisServerBaseUri; //cs.rest.server.thisServerBaseUri:http://127.0.0.1:9084
	private String transactionNotifyPath; //cs.rest.server.transactionNotifyPath:/api/account/transaction/notify
	private String oAuthTokenPath; //cs.rest.server.oAuthTokenPath:/oauth/token
	private String oAuthKeyStorePassword;
	private Integer nonAirtimeRequestTimeoutMs;
