...
Successful request full reversal for an airtime sell to a subscriber
    [Documentation]      Sell Airtime request full reversal to a subscriber
    ...
    Request Full Reversal     ${ref}    ${reason}   ${agent}
...
Successful request partial reversal for an airtime sell to a subscriber
    [Documentation]      Sell Airtime request partial reversal to a subscriber
    ...     USSD confirmation is disabled for the agent
    [Setup]     Open Admin Gui Login Page
    [Teardown]   Close All Browsers
    Login To Admin Gui    ${ROBOT1_USER}    ${ROBOT1_PASS}
    ...
    ${agent_bal_before}=   Get From List  ${agent_bal}  0
    Clear Call and Sms History On Airsim
    Request Partial Reversal   ${ref}    ${reason}     ${partial_amount}   ${agent}
#    Sleep    1
    Logout From Admin Gui
    Login To Admin Gui      ${ROBOT2_USER}      ${ROBOT2_PASS}
    Approve request
...
Successful request full reversal for a transfer from eMaster to eIntermed
    [Documentation]      Transfer request full reversal from eMaster to eIntermed
    ...     USSD confirmation is disabled for the agent
    [Setup]     Open Admin Gui Login Page
    [Teardown]   Close All Browsers
    Login To Admin Gui    ${ROBOT1_USER}    ${ROBOT1_PASS}
    ...
    Clear Call and Sms History On Airsim
    Request Full Reversal   ${ref}    ${reason}     ${a_agent}
#    Sleep    1
    Logout From Admin Gui
    Login To Admin Gui      ${ROBOT2_USER}      ${ROBOT2_PASS}
    Approve request
...
Successful request partial reversal for a transfer from eMaster to eIntermed
    [Documentation]      Transfer request partial reversal  from eMaster to eIntermed
    ...     USSD confirmation is disabled for the agent
    [Setup]     Open Admin Gui Login Page
    [Teardown]   Close All Browsers
    Login To Admin Gui    ${ROBOT1_USER}    ${ROBOT1_PASS}
   ...
   ${coauth_user}=     Set Variable    ${ROBOT2_USER}
    ...
    ${b_bon_before}=   Get From List  ${b_bal}  1
    Clear Call and Sms History On Airsim
    Request Partial Reversal   ${ref}  ${reason}     ${partial_amount}   ${a_agent}
#    Sleep   1
    Logout From Admin Gui
    Login To Admin Gui      ${ROBOT2_USER}      ${ROBOT2_PASS}
    Approve request
