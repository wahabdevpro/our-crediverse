# Summary
## Test Description
As an agent, I want to verify that the monthly sales summary monetary value for bundle sales for this month and last month in the stats section of the SmartApp are calculated correctly. 
## Preconditions
...
| 4 | Verify the monetary value total for this month and last month  |  | The monetary value for bundle sales for this month and last month should have the correct values |  |	 |  | 