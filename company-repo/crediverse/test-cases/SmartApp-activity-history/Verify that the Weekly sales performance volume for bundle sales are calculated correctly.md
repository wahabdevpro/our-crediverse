# Summary
## Test Description
As an agent, I want to verify that the weekly sales summary volume for bundle sales for this week and last week in the stats section of the SmartApp are calculated correctly. 
## Preconditions
...
| 4 | Verify the volume total for this week and last week  |  | The volume for bundle sales for this week and last week should have the correct values |  |	 |  | 