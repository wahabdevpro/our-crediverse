# Summary
## Test Description
Retail charge is populated to the TDRs and also to ec_transact and ap_transact table for all the airtime sales transactions
## Preconditions
...
| ------------ | ---------------| ------------- | ------------------- | ----------------- | ---------- | --------- |
| 1 | Dial USSD to perform Airtime sale |  | Airtime sale transaction is successful | |  | |
