# Summary
## Test Description
Cost of Goods Sold (COGS) is populated to the TDRs and also to ec_transact and ap_transact table for all the self top-up transactions
## Preconditions
...
| ------------ | ---------------| ------------- | ------------------- | ----------------- | ---------- | --------- |
| 1 | Perform a  self top-up transaction from Smartapp |  | Self top-up transaction is successful | |  | |
